module.exports = {
    ...
    hidden: true,
    execute(msg, args) {        
        if(!checkOwner()) { msg.channel.send('Only the bot owners can use this command!'); sendLog(msg.author.tag + ' tried to say something, but failed in ' + msg.guild.name); } else {
