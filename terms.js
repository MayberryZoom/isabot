module.exports = {
  ...
  dashback:
   { definition:
     ...
     character: 'General' },
       atkc:
   { definition:
      'Attack Cancel. You can jump out of the startup of tilts and dash attacks which can be useful. https://youtu.be/v1kjQtMaPkE',
     character: 'General' },
  'attack cancel':
   { definition:
      'Attack Cancel. You can jump out of the startup of tilts and dash attacks which can be useful. https://youtu.be/v1kjQtMaPkE',
  ...
  sd:
   { definition:
      'An SD is a __S__elf __D__estruct, where a player accidentally or intentionally leads themselves into the blast zone. When done intentionally, it is usually with intention to end the game early, either due to an incorrect stage/character pick, button testing, or because the player is simply upset.',
     character: 'General' },
  'edge guard':
   { definition:
      'An Edge Guard is the act of preventing a player from returning to the stage after knocking them off of it, usually by using an attack to knock them away/prevent them getting closer to the stage.',
     character: 'General' },
  'ledge guard':
   { definition:
      'A Ledge Guard is done by reacting and acting against someone\'s ledge options in order to deal more damage to them, knock them off of the stage or outright KO them.',
     character: 'General' },
  jv:
   { definition:
      'A JV, coined by and named after the Smash player \'JV3x3\' is where you defeat an opponent with 0% on your currennt stock. JVs are followed up usually by a number, being how many stocks you have remaining + the 0%, so if you have 3 stocks remaining and 0% when you defeat an opponent, it would be considered a JV4.',
     character: 'General' },
  matchup:
   { definition:
      'Matchup, the discussion of and understanding how well one character performs against another character.',
     character: 'General' },
  hitbox:
   { definition:
      'Hitboxes are a structure used in Smash to cause moves to deal damage to an opponent when it comes into contact with their hurtbox (see: hurtbox). Hitboxes cannot be seen normally without the use of mods or external software.',
     character: 'General' },
  hurtbox:
   { definition:
      'Hurtboxes are a structure used in Smash that, when comes in contact with a hitbox (see: hitbox), will cause whoever the hurtbox is attached to to take damage. Hurtboxes cannot be seen normally without the use of mods of external software.',
     character: 'General' },
  'ledge cancel':
   { definition:
      'A Ledge Cancel is performed by cancelling an aerial/special or its endlag by using said aerial/special near a ledge and then sliding off of it. These can be used to open up more movement options, making punishes more difficult for opponents if the move misses and possibly opening up combo potential.',
     character: 'General' },
  tech:
   { definition:
      'Teching, officially referred to as a \'fall break\' in Smash Ultimate, is performed by pressing the shield button or air-dodging into the ground, a wall or a ceiling before hitting the ground while in the tumble animation, cancelling all knockback and is accompanied with temporary invincibility during the tech animation.\n\nA standard tech is performed by teching into the ground. Teching into the ground while holding down lets you tech in place, and holding forwards or backwards lets you perform a tech roll. Tech rolls vary in length and speed between characters, and some may be faster/slower or cover more/less distance than a regular roll.\n\nTeching into a wall is known as a wall tech. Teching into a wall normally will cancel momentum and cause you to drop down, holding away after teching allows you to perform a tech wall jump, and holding in will allow you to cling to the wall immediately after teching (character dependant).\n\nLastly is ceiling techs, which allow you cancel momentum off of a ceiling. There is only one variation of this tech, which causes you to drop down from the ceiling immediately after teching, however they are still extremely important to prevent being stage-spiked!',
     character: 'General' },
  spike:
   { definition:
      'A spike is a move in Smash that launches an opponent downwards. Spikes are unable to be cancelled by a jump or up-b like meteors (see: meteor) and, as a unique feature to Smash Ultimate, opponents are unable to tech spikes if they are hit while grounded, allowing for possible true follow-ups.',
     character: 'General' },
  meteor:
   { definition:
      'A meteor is a move in Smash that launches an opponent downwards. Meteors are possible to be cancelled by a jump up-b unlike spikes (see: spike) and are exclusive to Melee and Brawl:\n__Melee__\nIn Melee, meteor cancelling is possible to perform 8 frames after the hitlag of a move has ended. In order however to cancel the meteor twice or more in a row while recovering, you must have at least allowed the control stick to return to neutral position, or else the jump/up-b will not come out.\n\n__Brawl__\nBrawl\'s hitlag is unique and slightly more in-depth than Melee\'s. Meteor cancels require the same waiting time universally across all moves, being (for majority of characters) 25 frames. If a jump or up-b is input however just before or during the hitlag of a meteor however, a 40 frame penalty is added.\n\nSome characters in Brawl also have a unique number of frames before they\'re able to cancel the meteor, including:\n**Charizard** with 30 frames.\n**Olimar**, **Ivysaur** and **Zero Suit Samus** with 15 frames.\n**Meta Knight** and **Pit** with 32 frames.\n**Wolf** with 60 frames.\n**Yoshi** with 20 frames.',
     character: 'General' },
  hitstun:
   { definition:
      'Hitstun is a period of time after being hit/launched by a move you are unable to act. Hitstun is dependant on a move\'s knockback, and is essentially for combos as it allows for a move to have a true follow up if the move after is able to hit the opponent while they\'re still in hitstun.\nNot to be confused with: hitlag',
     character: 'General' },
  hitlag:
   { definition:
  ...
  cheerless:
   { definition:
      'If you get a synced grab with ICs, when you input a throw Nana will do a taunt (called cheer). This means she cannot act while you are throwing. Certain setups can allow you to get a cheerless throw, where Nana will be able to buffer an option as you throw, before she cheers. An example of this is the yeet.https://youtu.be/377qQF66n9M',
     character: 'Ice Climbers' },
  synced:
   { definition:
  ...
  'tilt turn':
   { definition:
      'The second hardest, and also second most useful neutral desync, second in both ways only to Blizzard Wavedash.\nhttps://twitter.com/v23God/status/1114949522256539648',
     character: 'Ice Climbers' },
  'blizzard wavedash':
   { definition:
  ...
  soymilk:
   { definition:
      'Soymilk desync aka "skid turn": Dash in one direction until you enter run, then let go of the control stick to enter skid, then move the control stick in the opposite direction so Popo enters turn, and quickly interrupt the turning animation with any grounded move. If done correctly, Popo will perform the move and Nana will perform a short dash forward.\n\nTechnical details: Just like with other run turn desynchs, you have to input the move before Nana goes into turn so that she interprets the turn input as a dash forward. Out of skid, dash interrupts as early as frame 8. So you have to skid, turn, and then input a move at least 8 frames after the original skid, but less than 6 frames after the turn',
     character: 'Ice Climbers' },
     'skid turn':
     { definition:
    ...
    'corner carry':
     { definition:
        'Alternative name for Nut or any of its derivatives that carry the opponent to the corner for a cheerless conversion.',
       character: 'Ice Climbers' },
    'ruri combo':
     { definition:
        'A solid conversion off of synced grab at mid percents. https://twitter.com/ruripikaics/status/1105443229095190529',
       character: 'Ice Climbers' },
    'chars doc':
     { definition:
        'Doc that lists what specific things work on which characters, such as utilt (footstool squall), (utilt) footstool as an infinite, and the gimfinite. Work in progress, contact techy#5973 for editing access/corrections. https://docs.google.com/spreadsheets/d/1WI_xGi1OQ3b0bhrue42OqjrlufqYJQXM2m0FNil6-hw/edit#gid=0',
       character: 'Ice Climbers' },
    'squall desync':
     { definition:
        'At the end of squall, you can buffer an option just for nana, and then buffer something for popo, so that they perform two different things. \nBasics: <https://twitter.com/v23God/status/1102950879672627207>\nTechnical Details: <https://www.youtube.com/watch?v=xVuxZxmc358>',
       character: 'Ice Climbers' },
    nanatrump:
     { definition:
        'While trumping is only mediocre for a lot of characters in this game, since the opponent can DI in or away from the stage and limit your options for directly punishing it, Ice Climbers has what is likely the best trump punishes in the game. The answer is to make nana trump the opponent, while immdiately hitting ledge with popo fsmash. This is called nanatrump.\nThere are two main ways to do this - \n1. Run towards ledge and pivot grab towards center stage right before you reach ledge. While popo is in the endlag from the pivot grab, you can trump with nana.\n2. You can jump towards ledge, and if you space your landing just right, nana will grab ledge but popo will land on stage.\n\nAs nana trumps the opponent, you must immediately fsmash the ledge with popo. If done properly, they will get hit by the fsmash immediately after breaking contact with the ledge, which guarantees the fsmash.\nExample: https://twitter.com/bigd_ssb/status/1086753626670809088',
       character: 'Ice Climbers' },
    'dashgrab dashthrough':
     { definition:
        '[OBSOLETE, REMOVED AS OF 3.0] If you initiate a dash, then wait 6 frames for nana to initiate her dash, and then grab an opponent during nana\'s initial dash animation, and continue to hold forward, nana will keep running (foxtrotting technically) forward  past popo until she is out of control range. Very similar to semisync, and technically this sets up a cheerless, though its uses are more limited. Near ledge, you can have nana walk to the ledge, which can set up a teeter cancel, if you are precise. Otherwise, you can have nana grab ledge, and then do the following - https://gfycat.com/marvelousobesecranefly',
       character: 'Ice Climbers' },
    'teeter cancel':
     { definition:
        'If you can get nana to teeter on the edge of a platform or the main stage, you can guarantee a cheerless throw from it. Nana will not cheer if she is teetering when you throw someone. This can be setup\n1. in the same way that nanatrump is setup with whiff grab\n2. with a dash towards ledge\n3. airdodging onto a platform with the right timing\nExamples-<https://gfycat.com/DearElaborateAlaskanmalamute>\n<https://youtu.be/Yp69Y3gjSMk>',
       character: 'Ice Climbers' },
    'double uair':
     { definition:
        'If you do a short hop buffered uair, and then buffer another uair right before landing, Nana\'s uair will autocancel, and you can input something for nana right before you land, which popo will ignore. See also: bair uair\nexample (substitute bair for uair): https://gfycat.com/BlueFlimsyCod',
       character: 'Ice Climbers' },
    'bair uair':
     { definition:
        'If you do a short hop buffered bair, and then buffer an uair right before landing, Nana\'s uair will autocancel, and you can input something for nana right before you land, which popo will ignore. See also: double uair\nexample: https://gfycat.com/BlueFlimsyCod',
       character: 'Ice Climbers' },
    'izaw guide':
     { definition:
        'A beginners intro to a few useful ICs things. https://www.youtube.com/watch?v=Y2uVdqAVoUQ',
       character: 'Ice Climbers' },
    'footstool squall':
     { definition:
        'If you get a popo solo utilt, you can footstool with nana and immediately input squall with nana, which will drag the opponent down potentially into a grab. https://youtu.be/gnKpZjXZA40',
       character: 'Ice Climbers' },
    'rollback desync':
     { definition:
        'you can roll while also launching nana forward and squalling. technical details are in the video description: https://youtu.be/lA6l1H_DcMQ',
       character: 'Ice Climbers' },
    'utilt footstool':
     { definition:
        '(utilt) footstool AD down is a semi useful combo, which is infinite on certain floaties, but otherwise can be teched and therefore is not super reliable.',
       character: 'Ice Climbers' },
    notation:
     { definition:
        '__**Ice Climbers combo notation:**__\n**Fair** - this is a synced Fair, performed by both climbers\n**(Fair)** - this is a desynced Fair, performed by Nana (secondary climber) only\n**[Fair]** - this is a desynced Fair, performed by Popo [primary climber] only\n**DThrow** - this is a synced, cheered DThrow\n**[DThrow]** - this is a desynced, cheerless DThrow\nUsing arrows between components (DThrow > Uair) is helpful but not necessary. Use them to convey a sense of timing, where arrows represent inputs that are not performed almost simultaneously.',
       character: 'Ice Climbers' },
    'dthrow desync':
     { definition:
        'When you do a synced, cheered dthrow, you can buffer an option for Nana that Popo will not read in a 3 frame window, after Nana\'s cheer. This means that you can dthrow with Popo, and have Nana buffer just about anything, such as jump, blizzard, and roll (which is that is used to perform the Nut combo).',
       character: 'Ice Climbers' },
    'blizz confirms':
     { definition:
        'Kill Confirms out of a synced blizzard freeze: https://twitter.com/techyCoder81/status/1119463888410562560',
       character: 'Ice Climbers' },
    'cheer cancel':
     { definition:
        'You can buffer certain options for nana as popo\'s grab is coming out but before it actually lands. This is called cheer cancel.Frame data:\nThe window for grab (spotdodge) is 5 frames from standing grab (-3 to +1, with grab being f0), and  6 frames from grab during initial dash (-2 to +3). You can also Roll with the same timing. This window works because you can input down before the grab, and popo\'s grab input will count as a shield input for Nana. And of course, down + shield == spotdodge.\n\nThe window for grab (AB smash) is 2 frames from standing grab (0 to +1, with grab being f0), and 3 frames from grab during initial dash (+1 to +3). This is the generalized window for things that aren\'t roll or spotdodge. For example, you can grab (jump) , or grab (taunt) with this same timing.\n\nUnfortunately, while you CAN do tilts and specials while grabbing they are all a 1 frame window from a dash grab, and are not possible from a standing grab. In the future I may do a more in depth video on the specific reasons for why that is the case, but for now just don\'t worry about that at all. 100% not worth it. Spotdodge is objectively the best. https://www.youtube.com/watch?v=m-NKjph9fFI&feature=youtu.be',
       character: 'Ice Climbers' },
    dcc:
     { definition:
        'Dash Cheer Cancel. This is when you perform a cheer cancel out of your initial dash. https://www.youtube.com/watch?v=m-NKjph9fFI&feature=youtu.be\nSee also: cheer cancel, scc',
       character: 'Ice Climbers' },
    scc:
     { definition:
        'Standing Cheer Cancel. This is when you perform a cheer cancel while standing. https://www.youtube.com/watch?v=m-NKjph9fFI&feature=youtu.be\nSee also: cheer cancel, dcc',
       character: 'Ice Climbers' },
    'nair interrupt':
     { definition:
        'basically if you hit someone with the first 2 frames of nair in a sh, you can buffer a squall for nana instead of the nair. https://www.youtube.com/watch?v=MTe5xxQPvEY',
       character: 'Ice Climbers' },
    blizzwall:
     { definition:
        'Blizzwall is desynced blizzards in neutral. specifically, its when you alternate nana/popo blizzard to form a soft of wall of blizzard forwards, sometimes short hopping, sometimes moving backward or forward. When performed correctly, there is no gap in the blizzard projectiles, since each one covers the endlag of the one that came before it. The counterplay to this is jumping, which can be uaired instead. Many characters have specific moves that can hit you through blizzwall, so keep these in mind.',
       character: 'Ice Climbers' },
    'landing lag':
     { definition:
        'Landing lag desync is a way to desync off of any landing lag. https://www.youtube.com/watch?v=79BBYmOR78I',
       character: 'Ice Climbers' },

   // wii fit trainer
  hc:
   { definition:
      'Header Cancel. This can be performed by using Header and then pressing your shield/airdodge button. This will put you in a temporary helpless state, but will allow you to hit the ball in many different directions, as seen in <#536384936563965967>.',
     character: 'Wii Fit Trainer' },
  db:
   { definition: 'Deep Breathing', character: 'Wii Fit Trainer' },
  'hoop kick':
   { definition:
      'Performed offstage. Grab the ledge after hitting an enemy with Super Hoop, and then quickly let go of the ledge and use Back Air. Command: .hoopkick',
     character: 'Wii Fit Trainer' },
  dbc:
   { definition:
      'Deep Breathing Cancel. You can cancel Deep Breathing by pressing your shield/airdodge button. This is most effectively performed on the ground, because you can then jump out of shield, while in the air, you will be helpless after your airdodge.',
     character: 'Wii Fit Trainer' },
  'header getup':
   { definition:
      'A tech that is performed while hanging on the ledge.  Let go of the ledge, jump, and then use Header. If performed correctly, Wii Fit Trainer will progressively go up in height, until they are on stage. You can follow this up with other moves for shield pressure / shield breaking, or as a combo starter. For a visual, please use the command .headergetup',
     character: 'Wii Fit Trainer' },
  'header shielding':
   { definition:
      'Use a Header Cancel, but do not hit the ball after using it. Instead, simply use shield. This tech will cause an opponent who attacks you to be in hitlag for an extended duration, making it much easier for us to punish. For more detailed information, please use the command .headershielding',
     character: 'Wii Fit Trainer' },
  'sun blocking':
   { definition:
      'This tech involves charging Sun Salutation. Simply charge your sun and it will block some projectiles. The windbox on the charge can also block an edgeguard attempt. You can find a list of moves that this will block by using the command .sunblocking',
     character: 'Wii Fit Trainer' },
  headwhiffing:
   { definition:
      'This can only occur after coming out of strong hitstun, typically a smash attack. Once you are getting out of hitstun, use Header. Wii Fit Trainer will miss the ball, and you will be able to hit it with another move, typically dair. This is especially useful for reverse edgeguarding. For more information, use the command .headwhiff',
     character: 'Wii Fit Trainer' }
}